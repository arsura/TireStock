...
<html lang="en">
  <head>
    ...
    <title>โปรแกรมจัดการรายการสินค้า</title>

    <!-- Bootstrap core CSS -->
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <link href="index_style/ie10-viewport-bug-workaround.css" rel="stylesheet">
    ...
    <script src="index_style/ie-emulation-modes-warning.js"></script>

    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
      <script src="index_style/html5shiv.min.js"></script>
      <script src="index_style/respond.min.js"></script>
    <![endif]-->
  </head>
  ...
  <body>
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">จัดการสินค้า</h1>
              ...
              <a href="cancel_order.php" class="btn btn-lg btn-default">ยกเลิกออร์เดอร์</a> 
    ...
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="index_style/ie10-viewport-bug-workaround.js"></script>
  </body>
